...
public class GirlNinja : ChessPieceBase
{
	...
	public override void HighlightMoves()
	{
		...
		if (MyColor.ToString().CompareTo("Black") == 0)
		{
			...
			{
				if ((transform.localPosition.x + 1 == space.transform.localPosition.x && transform.localPosition.z + 2 == space.transform.localPosition.z)
				 || (transform.localPosition.x + 1 == space.transform.localPosition.x && transform.localPosition.z - 2 == space.transform.localPosition.z)
				 || (transform.localPosition.x - 1 == space.transform.localPosition.x && transform.localPosition.z + 2 == space.transform.localPosition.z)
				 || (transform.localPosition.x - 1 == space.transform.localPosition.x && transform.localPosition.z - 2 == space.transform.localPosition.z)
				 || (transform.localPosition.x + 2 == space.transform.localPosition.x && transform.localPosition.z + 2 == space.transform.localPosition.z)
				 || (transform.localPosition.x + 2 == space.transform.localPosition.x && transform.localPosition.z - 2 == space.transform.localPosition.z)
				 || (transform.localPosition.x - 2 == space.transform.localPosition.x && transform.localPosition.z + 2 == space.transform.localPosition.z)
				 || (transform.localPosition.x - 2 == space.transform.localPosition.x && transform.localPosition.z - 2 == space.transform.localPosition.z))
				{
