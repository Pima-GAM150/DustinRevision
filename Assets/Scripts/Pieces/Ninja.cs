...
public class Ninja : ChessPieceBase
{
	...
	public override bool Move(Transform target)
	{
		...
		if (((transform.localPosition.x + 1 == target.localPosition.x && transform.localPosition.y + 1 == target.localPosition.y)
		 || (transform.localPosition.x + 1 == target.localPosition.x && transform.localPosition.y - 1 == target.localPosition.y)
		 || (transform.localPosition.x - 1 == target.localPosition.x && transform.localPosition.y + 1 == target.localPosition.y)
		 || (transform.localPosition.x - 1 == target.localPosition.x && transform.localPosition.y - 1 == target.localPosition.y)
		 || (transform.localPosition.x == target.localPosition.x && transform.localPosition.y + 1 == target.localPosition.y)
		 || (transform.localPosition.x == target.localPosition.x && transform.localPosition.y - 1 == target.localPosition.y)
		 || (transform.localPosition.x + 1 == target.localPosition.x && transform.localPosition.y == target.localPosition.y)
		 || (transform.localPosition.x - 1 == target.localPosition.x && transform.localPosition.y == target.localPosition.y)))
		{
	...
	public override bool Attack(Transform target)
	{
		...
		if ((transform.localPosition.x + 2 == target.localPosition.x && transform.localPosition.y + 2 == target.localPosition.y)
